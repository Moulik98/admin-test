...
const CouponsTableRow = (props) => {
  ...
  const handleDelete = () => {
    const url = `${process.env.REACT_APP_URL}/v1/coupon/delete/admin/${id}`; // Replace with your API endpoint
      ...
      (async () => {
        try {
          const response = await fetch(
            `${process.env.REACT_APP_URL}/v1/coupon/activate-coupon/admin/${id}`,
            {
              method: "POST",
              headers: {
                "Content-Type": "application/json",
