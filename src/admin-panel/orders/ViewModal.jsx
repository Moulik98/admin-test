...
const ViewModal = (props) => {
    ...
    useEffect(() => {
        ...
        try {
            fetch(`${process.env.REACT_APP_URL}/v1/order/viewOrder/admin/${id}`, {
                method: 'GET',
                headers: {
                ...
                <div className="max-w-6xl flex flex-wrap justify-around m-auto ">
                    <div className='flex shrink-0 basis-5/12 flex-col py-2 shadow-[0px_1px 6px_rgba(208,208,208,0.61)] '>
                        ...
                        <div className=' flex text-xs  text-gray-900'>
                            ...
                            <div className='w-1/2 font-normal pl-5 text-xs'>{orderDetails?.user_order_id}</div>
                        </div>
                        <div className=' flex text-xs  text-gray-900'>
                        ...
                        <div className=' flex text-xs  text-gray-900'>
                            ...
                            <div className='w-1/2 font-normal pl-5 text-xs'>{orderDetails?.order_date}</div>
                        </div>
                        <div className=' flex text-xs  text-gray-900'>
                        ...
                        <div className=' flex text-xs  text-gray-900'>
                            ...
                            <div className='w-1/2 font-normal pl-5'>{orderDetails?.payment_status}</div>
                        </div>
                    ...
                    <div className='flex shrink-0 basis-5/12 flex-col py-2 shadow-[0px_1px 6px_rgba(208,208,208,0.61)] '>
                        ...
                        <div className=' flex text-xs  text-gray-900'>
                            ...
                            <div className='w-1/2 font-normal pl-5 text-xs'>{orderDetails?.email}</div>
                        </div>
                        <div className=' flex text-xs  text-gray-900'>
