...
const AddChildAttribute = () => {
    ...
    useEffect(() => {
        fetch(`${process.env.REACT_APP_URL}/v1/attributes/get?page=1&limit=500`)
            .then(res => res.json())
            .then(data => {
    ...
    useEffect(() => {
        fetch(`${process.env.REACT_APP_URL}/v1/category-attributes/get-populated?page=1&limit=500&filter[category_id][$eq]=${attributeData.id}`)
            .then(res => res.json())
            .then(data => {
                ...
                <section>
                    <div className='max-w-6xl mx-auto py-2'>
                        <div className='flex flex-col'>
                            <h2 className='text-3xl text-gray-900 flex item-left font-semibold'>Child Categories</h2>
                            <p className='text-base font-semibold flex item-left text-[#0057FF] mt-2'>Categories {'>'} ChildCategories</p>
                        </div>
                    </div>
                </section>
                {/* // Selected Categories */}
                    ...
                    <div className='max-w-6xl mx-auto mt-10'>
                        ...
                        >
                            ...
                            <div className='flex gap-4 justify-end py-2'>
                                <Link to='/category/childcategory' className='py-2 px-24 bg-[#00388C] text-white rounded-xl'>Go Back</Link>
