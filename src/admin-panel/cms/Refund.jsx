...
const Refund= () => {
    ...
    useEffect(() => {
        const apiUrl = `${process.env.REACT_APP_URL}/v1/cms/refund-cancellation`;
            ...
            <div className='p-5'>
                <section>
                    <div className='max-w-6xl mx-auto flex justify-between py-5'>
                        <p className='text-2xl text-gray-900 font-semibold'>Refund & Cancellations</p>
