  ...
  return (
    <main>
      <div className="p-5">
        ...
        {isClicked ? (
          <EditModal modalName={`Edit Privacy`} onClose={setIsClicked} />
        ) : null}
        <section className="p-5 flex flex-row gap-x-1 border  border-[#E8E8E8] rounded">
          <div className="p-1 shrink-0 w-full  flex flex-col space-y-4 ">
            <div className="flex flex-row justify-between">
              <p className="text-base font-semibold">
              Getting Stared with Steex
              </p>
              <p
                onClick={() => setIsClicked(true)}
                className="text-base text-gray-900 font-semibold flex gap-x-2 justify-center items-center cursor-pointer"
              >
                Edit
                <span>
                  <svg
