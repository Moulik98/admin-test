                ...
                <section className='p-5 flex flex-row gap-x-1 border bg-blue-950 border-[#E8E8E8] rounded'>
                    <div className='p-1 shrink-0 w-full  flex flex-col space-y-4 '>
                        <div className='flex flex-row justify-between'>
                            <p className='text-base text-white font-semibold'>General Questions</p>
                            <p
                                onClick={() => setIsClicked(true)}
                                className='text-base text-gray-100 font-semibold flex gap-x-2 justify-center items-center cursor-pointer'>Edit
                                <span>
                        ...
                        <div>
                            <p className='text-sm text-[#878A99] font-normal text-white text-left'>General knowledge is information that has been accumulated over time through various mediums and sources. It excludes specialized learning that can only be obtained with extensive training and information confined to a single medium.</p>
                        </div>
                    </div>
