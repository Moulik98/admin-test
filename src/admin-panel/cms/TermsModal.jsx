...
const TermsModal = ({ modalName, onClose, id, sectionId, apiUrl }) => {
    ...
    useEffect(() => {
        if (id && sectionId) {
            const url = `${process.env.REACT_APP_URL}/v1/cms/edit-terms/${id}`
            ...
            const url = `${process.env.REACT_APP_URL}/v1/cms/terms-condition/${id}`
