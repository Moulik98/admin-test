...
const TableRow = ({ data, index, length }) => {
    const { name, type, phone, email, country, orderCount, totalSpend, aov, last_active, register_date, status } = data;
    return (
        <tr class="border-b border-solid border-gray-200 bg-white hover:bg-gray-50 text-[#222222]">
            <td class="px-2 py-2 whitespace-nowrap "><input type='checkbox' /></td>
            <td class="px-2 py-2 whitespace-nowrap ">{name}</td>
